                ...
                <div class="card-body">
                    <form class="forms-sample" method="POST">
                        <div class="form-group">
                            <label>发布人</label>
                            <p><?php echo htmlspecialchars($sender, ENT_QUOTES, "UTF-8"); ?></p>
                            <input type="hidden" class="form-control" name="sender" value='<?php echo htmlspecialchars($sender, ENT_QUOTES, "UTF-8"); ?>'>
                        </div>
                        <div class="form-group">
                            <label>接受人</label>
